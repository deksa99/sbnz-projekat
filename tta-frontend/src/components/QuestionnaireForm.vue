    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" v-model="racketRecommendationForm.rainingExperience" value="BEGINNER" type="radio" name="BEGINNER" id="BEGINNER">
                    ...
                    <div v-for="situation in racketRecommendationForm.situations" :key="situation.id" class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" v-model="situation.racketOrientation" value="FOREHAND" type="radio" :id="'forehand' + situation.id">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" v-model="situation.response" value="HIT" type="radio" :id="'hit' + situation.id">
